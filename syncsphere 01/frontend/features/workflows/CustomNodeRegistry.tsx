...
import {
  ...
  Repeat, Clock, Globe, Webhook, Database, HelpCircle,
} from 'lucide-react';
...
export const NODE_TYPE_REGISTRY: NodeTypeInfo[] = [
  ...
  { type: 'connector', label: 'Connector',   description: 'MCP tool invocation',           icon: <Radio className="h-4 w-4" />,         color: 'text-sky-500',     category: 'integration' },
  { type: 'approval',  label: 'Approval',    description: 'Human approval gate',           icon: <ShieldCheck className="h-4 w-4" />,   color: 'text-orange-500',  category: 'integration' },
