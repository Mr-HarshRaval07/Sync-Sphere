...
import {
  ...
  ToggleLeft, ToggleRight, ChevronDown, Variable,
} from 'lucide-react';
...
const NODE_CONFIG_FIELDS: Record<string, FieldDef[]> = {
  ...
  connector: [
    { key: 'connector_id', label: 'Connector', type: 'select', options: [
    ...
    { key: 'tool_name', label: 'Tool Name', type: 'text', placeholder: 'e.g. post_message' },
  ],
  approval: [
    ...
    { key: 'escalation_policy', label: 'Escalation Policy', type: 'text', placeholder: 'Policy ID' },
  ],
  knowledge: [
